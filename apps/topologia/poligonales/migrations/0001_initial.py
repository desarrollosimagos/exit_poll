    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cod_pol', models.IntegerField(max_length=2, verbose_name=b'C\xc3\xb3digo de la Poligonal')),
                ('poligonal', models.CharField(max_length=150, verbose_name=b'Nombre de la Poligonal')),
                ...
                ('estado', models.ForeignKey(related_name='estado_poligonal', on_delete=django.db.models.deletion.SET_NULL, to_field=b'cod_estado', to='estados.Estado', null=True)),
